              ...
              try {
                ...
                if (player && vc && vc.members.size === 1) {
                  var embed = new MessageEmbed()
                    .setTitle(`${emoji.msg.ERROR} คิวสิ้นสุด | ช่องว่าง`)
                    .setDescription(`ฉันออกจากช่อง: ${client.channels.cache.get(player.voiceChannel).name} เพราะช่องว่างสำหรับ: ${ms(config.settings.leaveOnEmpty_Channel.time_delay, { long: true })}`)
